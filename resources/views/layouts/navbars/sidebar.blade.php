<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ route('home') }}">
            <img src="{{ asset('panas-books') }}/img/logo-texto-blanco-cortado.png" class="navbar-brand-img" alt="..." width="150px" height="80px">
        </a>
        <!-- User -->
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    ...
                    <i class="fas fa-desktop"></i> {{ __('Principal') }}
                    </a>
                </li>
               ...
               @can('es_admin', Auth()->user())
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('r.editoriales') }}">
                ...
                @endcan
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('r.ventas') }}">
                    <i class="fas fa-address-book"></i>
