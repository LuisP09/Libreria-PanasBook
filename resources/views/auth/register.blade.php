                ...
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small>{{ __('Registrate con credenciales') }}</small>
                        </div>
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="text-muted font-italic">
                                <small>{{ __('Fuerza de la contraseña') }}: <span class="text-success font-weight-700">{{ __('fuerte') }}</span></small>
                            </div>
                            <div class="row my-4">
                                <div class="col-12">
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="customCheckRegister">
                                            <span class="text-muted">{{ __('Estoy de acuerdo con las') }} <a href="{{route('m.aviso')}}">{{ __('Politicas de privacidad') }}</a></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
